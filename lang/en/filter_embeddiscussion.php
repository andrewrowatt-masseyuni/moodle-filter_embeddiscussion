...
$string['setting_legacycomments_desc'] = 'If enabled, {comments} is converted to {discussion:<page name>} during filtering.';
$string['setting_legacyfilterdisqus'] = 'Use filter for legacy [[filter_disqus]] token';
$string['setting_legacyfilterdisqus_desc'] = 'If enabled, [[filter_disqus]] is converted to {discussion:<page name>} during filtering.';
